...
func TestDefaultRegistryHasV06Tools(t *testing.T) {
	...
	for _, name := range []string{"python", "pip", "jq", "yq", "terraform", "ffmpeg", "node", "npm", "npx", "go", "gofmt", "uv", "uvx"} {
...
func TestDefaultToolSections(t *testing.T) {
	...
	for _, name := range []string{"python", "yq", "terraform", "ffmpeg", "node", "node22", "npm", "npm22", "npx", "npx22", "go", "gofmt", "uv", "uvx"} {
