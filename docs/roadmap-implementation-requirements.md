...
| RM-31 self-update | **Selection/staging/verifier foundations shipped** | PR #76 shipped selection/check behavior; private staging and attestation verification followed. Transactional helper/apply wiring and E2E remain |
